...
ayear = int(datetime.now().timestamp()) + 3600 * 24 * 365
cookies = f"""# Netscape HTTP Cookie File
# This file is generated by yt-dlp.  Do not edit.

.youtube.com\tTRUE\t/\tTRUE\t{ayear}\t__Secure-3PSID\t{token}"""
if _3PSIDTS:
  cookies += f'\n.youtube.com\tTRUE\t/\tTRUE\t{ayear}\t__Secure-3PSIDTS\t{_3PSIDTS}'
if _3PAPISID:
  cookies += f'\n.youtube.com\tTRUE\t/\tTRUE\t{ayear}\t__Secure-3PAPISID\t{_3PAPISID}'
...
async def get_info(video_id):
  ...
  if 'playabilityStatus' in res:
    if res['playabilityStatus']['status'] in ('ERROR', 'LOGIN_REQUIRED'):
      logger.info(f"请求失败 playabilityStatus: {res['playabilityStatus']}")
